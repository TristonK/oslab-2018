...
void draw_start(){
  ...
  draw_rect1((index_x+1)* SIDE, (index_y+5) * SIDE, SIDE, SIDE, 0xff3030);
  draw_rect1((index_x+2)* SIDE, (index_y) * SIDE, SIDE, SIDE, 0xff3030);
  draw_rect1((index_x+2)* SIDE, (index_y+3) * SIDE, SIDE, SIDE, 0xff3030);
  draw_rect1((index_x+2)* SIDE, (index_y+5) * SIDE, SIDE, SIDE, 0xff3030);
  draw_rect1((index_x+3)* SIDE, (index_y) * SIDE, SIDE, SIDE, 0xff3030);
  draw_rect1((index_x+3)* SIDE, (index_y+4) * SIDE, SIDE, SIDE, 0xff3030);
}
